...
- **Name names**: "skill-testbed/ runs A/B skill experiments" not "there's a testing subsystem"
...
- **Subsystem boundaries**: what touches what and what's off-limits — "skill-testbed reads skills/ but never modifies them"
